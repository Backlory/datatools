...
from _tools import pesmod_tools as tools

class Dataset_PESMOD(_Dataset_Generater_Base):
    def __init__(self, dataset_path='',args={}) -> None:
        print('initializating Dataset_PESMOD...')
...
if __name__=="__main__":
    ...
    Dataset_generater = Dataset_PESMOD(Path.db_root_dir('pesmod'))
