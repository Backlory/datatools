...
from _tools import davis2017_tools as tools

class Dataset_Davis2017(_Dataset_Generater_Base):
    def __init__(self, dataset_path='',args={}) -> None:
        print('initializating Dataset_Davis2017...')
...
if __name__=="__main__":
    ...
    Dataset_generater = Dataset_Davis2017(Path.db_root_dir('davis2017'))
